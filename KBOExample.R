...
library(quanteda)
library(dplyr)
ltcorpus<-readLines("thelittlecorpus.txt")
...
#########################################################################
# Set bigram and trigram discounts and word prefix to use in prediction
#########################################################################
...
#########################################################
# Caluclate word probabilities for unobserved trigrams
#########################################################
...
#############################################################
# Calculate Backed off probabilities for Observed & Unobserved bigrams
#############################################################
...
unobs <- qbo_bigrams[-1,]
# Sum of unobserved bigrams should equal bigram discount
sum(unobs$prob)

###############################################################
# Calculted discounted probablility mass for trigrams 
###############################################################
...
#######################################################
# Calculate unobserved trigram probablities
#######################################################
